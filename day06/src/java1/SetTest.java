 ...
 *
 *1.Set接口中没有额外定义新的方法使用的都是Collection中声明过的方法。
 *
 * 2.要求：向Set中添加的数据，其所在的类一定要重写hashCode()和equals()
 *   要求：重新的hashCode()和equals()尽可能保持一致性：相等的对象必须具有相等的散列码
 *      重写两个方法的小技巧：对象中用作equals()方法比较的Field，都应该用来计算hashCode
 *
 *
 * @author yjh 1600063206@qq.com
 * @version 2023/5/10 10:52
 * @since JDK8
 */
public class SetTest {
        ...
        二，添加元素的过程：以HashSet为例：
            ...
            此哈希值接着通过某种算法计算出在HashSet底层数组中的存放位置（即为：索引位置），判断数组此位置上是否已经
            有元素：
    ...
    //数据后一个数据。
    //优点：对于频繁的遍历操作，LinkedHasSet效率高于HashSet
    @Test
    public void test2(){
