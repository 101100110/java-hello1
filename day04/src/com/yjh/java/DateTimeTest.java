...
public class DateTimeTest {
    ...
    public void testSimpleDateFormat() throws ParseException {
        ...
        //解析：格式化的逆过程，字符串--->日期
        String str="2019-08-09 上午11:43";
        Date date1 = sdf.parse(str);
        System.out.println(date1);

        //************使用指定的方式格式化和解析：调用带参的构造器********************
//        SimpleDateFormat sdf1 = new SimpleDateFormat("yyyyy.MMMMMMM.dd GGG hh:mm aaa");
        SimpleDateFormat sdf1=new SimpleDateFormat("yyyy-MM-dd hh:mm:ss");
        //格式化
        String format1 = sdf1.format(date);
        System.out.println(format1);//2022-12-26 11:18:24
...
//        System.out.println(calender.getClass());
        ...
        int years = calender.get(Calendar.DAY_OF_YEAR);
