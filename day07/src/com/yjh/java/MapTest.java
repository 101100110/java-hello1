 ...
 *      |----HashMap：作为一个Map的主要实现类;线程不安全，效率高；存储null的key和value
 ...
 *  Map中的entry:无序的，不开重复的，使用Set存储所有的entry
 *
 ...
 *      如果此位置上的数据不为空，（意味着此位置上存在一个或多个数值（以链表形式存在）），比较当前的key1和已经存在的
 *      一个或多个数据的哈希值：
 ...
 *      void putALL(Map m):将m中的所有key_value对存放到当前map中
 *      Object remove(Object key):移除指定key的key-value对，并返回value
 *      void clear():清空当前map中的所有数据
 *
 *
 * @author yjh 1600063206@qq.com
 * @version 2023/5/15 9:24
 * @since JDK8
 */
